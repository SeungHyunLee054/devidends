...
import zerobase.dividends.exception.impl.CouldNotFindTickerException;
import zerobase.dividends.exception.impl.UnexpectedMonthEnumValue;
...
public class YahooFinanceScraper implements Scraper {
    ...
    public ScrapedResult scrap(Company company) {
        log.info("scrap company -> {}", company.getName());
        ...
        try {
            ...
            String url = String.format(
                    STATICS_URL, company.getTicker(), START_TIME, now);
            ...
            Element tBody = tableEle.children().get(1);  // 0 : thead, 2 : tfoot
            ...
            for (Element e : tBody.children()) {
                ...
                if (month < 0) {
                    throw new UnexpectedMonthEnumValue();
                }

                dividends.add(new Dividend(LocalDateTime
                        .of(year, month, day, 0, 0), dividend));
    ...
    public Company scrapCompanyByTicker(String ticker) {
        ...
        try {
            ...
            throw new CouldNotFindTickerException();
        }
    }
}
